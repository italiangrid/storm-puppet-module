...
* [`manage_storm_properties`](#-storm--backend--manage_storm_properties)
* [`path_storm_properties`](#-storm--backend--path_storm_properties)
...
##### <a name="-storm--backend--manage_storm_properties"></a>`manage_storm_properties`

Data type: `Boolean`

If true, allows to set content of storm.properties file wuth the file pointed by path_storm_properties.

##### <a name="-storm--backend--path_storm_properties"></a>`path_storm_properties`
...
* [`storage_areas_source_directory`](#-storm--webdav--storage_areas_source_directory)
...
##### <a name="-storm--webdav--storage_areas_source_directory"></a>`storage_areas_source_directory`
...
##### <a name="-storm--webdav--scitags_enabled"></a>`scitags_enabled`
