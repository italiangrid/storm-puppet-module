    ...
    context "on #{os}" do
      ...
      context 'Define some test storage areas' do
        ...
        it "check environment file" do
          ...
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_USER=storm"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_HOSTNAME_0=storm-w1.example"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_HOSTNAME_1=storm-w2.example"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_HTTP_PORT=8080"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_HTTPS_PORT=9443"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_CERTIFICATE_PATH=\/etc\/grid-security\/storm-webdav\/hostcert.pem"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_PRIVATE_KEY_PATH=\/etc\/grid-security\/storm-webdav\/hostkey.pem"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_MAX_CONNECTIONS=200"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_MAX_QUEUE_SIZE=700"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_SA_CONFIG_DIR=\/etc\/storm\/webdav\/sa.d"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_VO_MAP_FILES_ENABLE=true"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_VO_MAP_FILES_CONFIG_DIR=\/etc\/storm\/webdav\/vo-mapfiles.d"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_VO_MAP_FILES_REFRESH_INTERVAL=22000"/)
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_LOG=\/var\/log\/storm\/webdav\/storm-webdav-server.log"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_LOG_CONFIGURATION=\/etc\/storm\/webdav\/logback.xml"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_ACCESS_LOG_CONFIGURATION=\/etc\/storm\/webdav\/logback-access.xml"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_CONNECTOR_MAX_IDLE_TIME=15000"/)
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_TRUST_ANCHORS_DIR=\/etc\/grid-security\/certificates"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_TRUST_ANCHORS_REFRESH_INTERVAL=80000"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_TPC_MAX_CONNECTIONS=100"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_TPC_VERIFY_CHECKSUM=true"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_JVM_OPTS=-Xms512m -Xmx1024m"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_AUTHZ_SERVER_ENABLE=true"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_AUTHZ_SERVER_ISSUER=https:\/\/storm-w1.example:9443"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_AUTHZ_SERVER_MAX_TOKEN_LIFETIME_SEC=43400"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_AUTHZ_SERVER_SECRET=secret"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_REQUIRE_CLIENT_CERT=true"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_USE_CONSCRYPT=false"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_TPC_USE_CONSCRYPT=false"/ )
          is_expected.to contain_file(service_file).with( :content => /Environment="STORM_WEBDAV_ENABLE_HTTP2=false"/ )
      ...
      context "Test conscrypt enabled configuration" do
        ...
        it "check sysconfig conscrypt configuration is enabled" do
          service_file='/etc/systemd/system/storm-webdav.service.d/storm-webdav.conf'
          is_expected.to contain_file(service_file).with( :content => /^Environment="STORM_WEBDAV_USE_CONSCRYPT=true"/ )
          is_expected.to contain_file(service_file).with( :content => /^Environment="STORM_WEBDAV_TPC_USE_CONSCRYPT=true"/ )
        end
      end
      ...
      context "Test HTTP2 enabled configuration" do
        ...
        it "check sysconfig http2 configuration is enabled" do
          service_file='/etc/systemd/system/storm-webdav.service.d/storm-webdav.conf'
          is_expected.to contain_file(service_file).with( :content => /^Environment="STORM_WEBDAV_ENABLE_HTTP2=true"/ )
        end
      end
      ...
      context 'Check sysconfig debug enabled with custom port but not suspended' do
        ...
        it "check service file" do
          ...
          is_expected.to contain_file(service_file).with( :content => /^Environment="STORM_WEBDAV_JVM_OPTS=-Xms256m -Xmx512m -Xdebug -Xrunjdwp:server=y,transport=dt_socket,address=1234,suspend=n"/ )
        end
      end
